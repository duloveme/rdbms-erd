...
export const enBundle: Record<I18nKey, string> = {
  ...
  "toolbar.lines.onlyNonHidden": "Show only non-hidden relationship lines",
  ...
  "toolbar.layoutLock.off": "Unlock layout editing",
  ...
  "toolbar.tooltipWithShortcut": "{{action}} ({{shortcut}})",
  ...
  "node.compactSummary": "{{count}} columns · summary",
  ...
  "dialog.tableDescription": "Description",
  ...
  "dialog.column.description": "Description",
  "dialog.column.type": "Type",
  "dialog.column.defaultValue": "Default Value",
  "dialog.column.defaultValuePlaceholder": "Default value",
  "dialog.column.pk": "PK",
